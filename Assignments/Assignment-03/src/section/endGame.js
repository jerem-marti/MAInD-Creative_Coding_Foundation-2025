...
/** HTML element displaying player 2's avatar.
 * @type {HTMLElement}
 */
const player1AvatarElement = document.getElementById('end-game-player1-avatar');
 ...
 * @type {HTMLElement}
 */
const player2AvatarElement = document.getElementById('end-game-player2-avatar');
...
const displayEndGame = () => {
    ...
    if (!latestGame) {
        ...
        player1AvatarElement.src = "";
        player2AvatarElement.src = "";
        scoreElement.textContent = "";
    } else {
        const player1 = latestGame.player1;
        const player2 = latestGame.player2;

        player1AvatarElement.src = player1.avatar;
        player2AvatarElement.src = player2.avatar;
